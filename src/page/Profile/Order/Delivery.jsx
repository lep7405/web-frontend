...
const Delivery = ({ texts }) => {
  ...
  return (
    <div>
      <h1 className="font-serif text-xl">Shipper is get items from warehouse</h1>
      {data?.map((item, index) => {
        return (
          <div
          ...
          >
            <div className="flex justify-between items-center mb-2">
              ...
              <div>
                ...
                <button className="py-2 px-5 rounded-xl bg-gray-400">{item.deliveryTime}</button>
              </div>
            </div>
            <div>
